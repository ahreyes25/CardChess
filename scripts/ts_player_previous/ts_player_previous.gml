...
if (_turn_controller.current_team_player_index > 0) {
	_turn_controller.current_team_player_index--;
}
else {
	_turn_controller.current_team_turn			= _turn_controller.previous_team_turn;
	_turn_controller.current_team_player_index	= ds_list_size(_turn_controller.current_team_turn) - 1;
	
	if (_turn_controller.current_team_index > 0)
		_turn_controller.current_team_index--;
	else
		_turn_controller.current_team_index = ds_list_size(_turn_controller.teams) - 1;
}
